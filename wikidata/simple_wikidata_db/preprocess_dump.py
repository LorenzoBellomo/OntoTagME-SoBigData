...
def get_arg_parser():
    ...
    parser.add_argument('--out_dir_full', type=str, required=True, help='path to the second, full output directory')
...
def main():
    ...
    out_dir_full = Path(args.out_dir_full)
    out_dir_full.mkdir(exist_ok=True, parents=True)  
