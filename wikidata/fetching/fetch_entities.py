...
from utils import jsonl_generator, get_batch_files, create_dir
...
with open("../config.json", 'r') as json_file:
    ...
    full_preprocessed_dir = "full_processing/"
    processed_dir = "minimal_processing/"
    csv_dir = "final_csv/"
...
def main():
    ...
    with open("{}page.csv".format(csv_dir), 'w') as page_file:
    ...
    with open("{}category.csv".format(csv_dir), 'w') as cat_file:
        for qid, info in all_data.items():
    ...
    with open("{}pagelinks.csv".format(csv_dir), 'w') as pagelinks_file:
