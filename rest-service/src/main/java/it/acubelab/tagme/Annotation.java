...
public class Annotation implements Serializable,Comparable<Annotation>{
	...
	public String toString() {
		int equal_s_pos = equal != null ? equal.getStart()    : -1;
		int equal_e_pos = equal != null ? equal.getEnd()      : -1;
		int super_s_pos = equal != null ? superior.getStart() : -1;
		int super_e_pos = equal != null ? superior.getEnd()   : -1;
		return "Annotation {" +
				"\nstart="     + start     +
				"\nend="       + end       +
				"\ntagged="    + tagged    +
				...
				"\nrho="       + rho       +
				"\nequal: "    +
				"\n\t start pos: " + equal_s_pos +
				"\n\t stop pos: "  + equal_e_pos +
				"\nsuperior:"  +
				"\n\t start pos: " + super_s_pos +
				"\n\t stop pos: "  + super_e_pos +
				'}';
	}
}
